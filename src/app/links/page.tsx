...
export default function Home() {
  ...
  return (
    <main className="overflow-hidden">
      ...
      <div className="flex flex-col justify-center items-center h-screen place-items-center gap-4 md:gap-8 gap-y-12 md:gap-y-4 px-2 md:px-0">
        <button
          className={`scale-125 md:scale-100 flex items-center justify-center bg-neutral-950 text-white px-6 py-4 text-lg rounded-full ${hoverEffect} z-20 w-48 `} onClick={() => (window.location.href = "https://twitter.com/sketchygfx__")}>
          <svg
